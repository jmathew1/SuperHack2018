...
// Choose a driving speed for the robot, from 0 to 400.
int straightSpeed = /* TO DO */;
...
// Reads the lines sensors and stores them in lineSensorValues array.  Also returns an estimation of the line position.
int readSensors()
{
  /* TO DO */
}
...
// Also sends an alert that the civilian has been resuced, then stops and waits for the button to be pressed again. 
void rescueCivilian()
{
  /* TO DO */
}
